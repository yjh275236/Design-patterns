...
class MementoDemoViewController: UIViewController {
    ...
    private func setupUI() {
        ...
        Memento（备忘录，保存状态）
        Caretaker（管理者，保存备忘录历史）
        
        ⚙️ 执行流程：原发器创建备忘录，管理者保存，需要时恢复状态
        """
...
extension MementoDemoViewController: UIScrollViewDelegate {
